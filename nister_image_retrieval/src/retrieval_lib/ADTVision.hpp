...
/*25/07/2015*/
/*Class to hold all the vision related algorithms together*/
/*etc.*/
...
namespace ADTVision 
{
	...
	struct SIFTParams 
	{
		SIFTParams(int max_features = 0, int num_octave_layers = 3,double contrast_threshold = 0.04, double edge_threshold = 11, double sigma = 1.6) : max_features(max_features), num_octave_layers(num_octave_layers),contrast_threshold(contrast_threshold), edge_threshold(edge_threshold), sigma(sigma) 
		{
